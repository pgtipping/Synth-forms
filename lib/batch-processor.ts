...
import { convertDOCX, convertXLSX, detectOfficeWatermark } from './office-converter';
...
export class BatchProcessor {
  private converter: LocalFormConverter;
  private processedCount: number = 0;
  private errors: Array<{ file: string; error: string }> = [];
  private convertedTemplates: Array<{ originalFile: string; templateId: string }> = [];
