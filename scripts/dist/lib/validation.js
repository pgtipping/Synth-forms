...
exports.processDependencies = exports.validateField = exports.Validator = exports.ValidationError = void 0;
const utils_1 = require("./utils");
Object.defineProperty(exports, "validateField", { enumerable: true, get: function () { return utils_1.validateField; } });
Object.defineProperty(exports, "processDependencies", { enumerable: true, get: function () { return utils_1.processDependencies; } });
...
class Validator {
    static validateTemplate(data) {
        ...
        // Category validation
        if (!((_b = data.category) === null || _b === void 0 ? void 0 : _b.trim())) {
    ...
    static validateFormFieldDefinition(field) {
        ...
        if (field.dependencies) {
            field.dependencies.forEach((dep, index) => {
                ...
                if (!((_a = dep.condition) === null || _a === void 0 ? void 0 : _a.operator))
